...
class TeknikSipil extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        isLoggedIn($this->session->userdata('id'));
        $this->load->model('Model_tekniksipil', 'tekniksipil');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $data['title'] = 'Teknik Sipil';
        $data['tekniksipils'] = $this->tekniksipil->getData();

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/tekniksipil/index', $data);
    ...
    {
        $data['title'] = 'Teknik Sipil | Tambah Teknik Sipil';
     
        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/tekniksipil/create', $data);
        $this->load->view('layouts/footer');
    }
    ...
    public function store()
    {
        ...
        'tendik_kontrak' => htmlspecialchars($this->input->post('tendik_kontrak')),
            ...
            $this->tekniksipil->storeData($data);

                if ($this->db->affected_rows() > 0) {
                    $this->session->set_flashdata('success', 'Berhasil menambah data!');
                    redirect('tekniksipil');
                } else {
    ...
    {
        $data['title'] = 'Teknik Sipil | Update Teknik Sipil';
        $data['data'] = $this->tekniksipil->editData($id);

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/tekniksipil/edit', $data);
        $this->load->view('layouts/footer');
    }
    ...
    public function update($id)
    {
        ...
        'tendik_kontrak' => htmlspecialchars($this->input->post('tendik_kontrak')),
            ...
            $this->tekniksipil->updateData($id, $data);
    ...
    {
        $this->tekniksipil->destroyData($id);

        if ($this->db->affected_rows() > 0) {
            $this->session->set_flashdata('success', 'Berhasil menghapus tekniksipil!');
            redirect('tekniksipil');
        } else {
            $this->session->set_flashdata('error', 'Gagal menghapus tekniksipil!');
            redirect('tekniksipil');
        }
    }
    ...
    {
        $data['title'] = 'Teknik Sipil | Detail Teknik Sipil';
        $data['data'] = $this->tekniksipil->showData($id);

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/tekniksipil/show', $data);
        $this->load->view('layouts/footer');
    }
