...
class TeknikInformatika extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        isLoggedIn($this->session->userdata('id'));
        $this->load->model('Model_teknikinformatika', 'teknikinformatika');
    ...
    public function index()
    {
        ...
        $data['teknikinformatikas'] = $this->teknikinformatika->getData();

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/teknikinformatika/index', $data);
    ...
    {
        $data['title'] = 'Teknik Informatika | Tambah Teknik Informatika';
     
        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/teknikinformatika/create', $data);
        $this->load->view('layouts/footer');
    }
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!$this->upload->do_upload('foto')) {
                ...
                redirect('teknikinformatika/create');
            } else {
        ...
        'tendik_kontrak' => htmlspecialchars($this->input->post('tendik_kontrak')),
            ...
            $this->teknikinformatika->storeData($data);

                if ($this->db->affected_rows() > 0) {
                    $this->session->set_flashdata('success', 'Berhasil menambah data!');
                    redirect('teknikinformatika');
                } else {
    ...
    {
        $data['title'] = 'Teknik Informatika | Update Teknik Informatika';
        $data['data'] = $this->teknikinformatika->editData($id);

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/teknikinformatika/edit', $data);
        $this->load->view('layouts/footer');
    }
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            if (!empty($_FILES['foto']['name'])) {
                ...
                if (!$this->upload->do_upload('foto')) {
                    $this->session->set_flashdata('error', $this->upload->display_errors());
                    redirect('teknikinformatika/edit/' . $id);
                } else {
                    $fileData = $this->upload->data();
                    $foto = $fileData['file_name'];
                }
        ...
        'tendik_kontrak' => htmlspecialchars($this->input->post('tendik_kontrak')),
            ...
            $this->teknikinformatika->updateData($id, $data);
    ...
    {
        $this->teknikinformatika->destroyData($id);

        if ($this->db->affected_rows() > 0) {
            $this->session->set_flashdata('success', 'Berhasil menghapus teknikinformatika!');
            redirect('teknikinformatika');
        } else {
            $this->session->set_flashdata('error', 'Gagal menghapus teknikinformatika!');
            redirect('teknikinformatika');
        }
    }
    ...
    {
        $data['title'] = 'Teknik Informatika | Detail Teknik Informatika';
        $data['data'] = $this->teknikinformatika->showData($id);

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/teknikinformatika/show', $data);
        $this->load->view('layouts/footer');
    }
