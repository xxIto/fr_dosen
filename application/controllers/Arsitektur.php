...
class Arsitektur extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Model_arsitektur', 'arsitektur');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $data['title'] = 'arsitektur';
        $data['arsitekturs'] = $this->arsitektur->getData();

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/arsitektur/index', $data);
    ...
    {
        $data['title'] = 'arsitektur | Tambah arsitektur';
     
        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/arsitektur/create', $data);
        $this->load->view('layouts/footer');
    }
    ...
    public function store()
    {
        ...
        'tendik_kontrak' => htmlspecialchars($this->input->post('tendik_kontrak')),
            ...
            $this->arsitektur->storeData($data);
    ...
    {
        $data['title'] = 'arsitektur | Update arsitektur';
        $data['data'] = $this->arsitektur->editData($id);

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/arsitektur/edit', $data);
        $this->load->view('layouts/footer');
    }
    ...
    public function update($id)
    {
        ...
        'tendik_kontrak' => htmlspecialchars($this->input->post('tendik_kontrak')),
            ...
            $this->arsitektur->updateData($id, $data);
    ...
    {
        $this->arsitektur->destroyData($id);

        if ($this->db->affected_rows() > 0) {
            $this->session->set_flashdata('success', 'Berhasil menghapus arsitektur!');
            redirect('arsitektur');
        } else {
            $this->session->set_flashdata('error', 'Gagal menghapus arsitektur!');
            redirect('arsitektur');
        }
    }
    ...
    {
        $data['title'] = 'arsitektur | Detail arsitektur';
        $data['data'] = $this->arsitektur->showData($id);

        $this->load->view('layouts/header', $data);
        $this->load->view('layouts/sidebar');
        $this->load->view('layouts/topbar');
        $this->load->view('dashboard/arsitektur/show', $data);
        $this->load->view('layouts/footer');
    }
