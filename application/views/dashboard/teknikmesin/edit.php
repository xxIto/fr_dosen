...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h1 class="h3 mb-0">Edit Teknik mesin</h1>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css">

  </div>

  <!-- Content Row -->
  <form id="form-teknikmesin" action="<?= base_url('teknikmesin/update/' . $data['teknikmesin_id']); ?>" method="POST" enctype="multipart/form-data">
   
    <!-- Teknik mesin Form -->
    <div class="card mt-3">
      <div class="card-header">
        <h3 class="card-title">Edit Teknik mesin</h3>
      </div>
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="nomor_teknikmesin">Nomor</label>
          <input type="text" class="form-control" name="nomor" id="nomor_teknikmesin" placeholder="Masukkan Nomor Surat" value="<?= $data['nomor'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" name="tanggal" id="tanggal_teknikmesin" value="<?= $data['tanggal'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama" id="nama_teknikmesin" placeholder="Masukkan Nama" value="<?= $data['nama'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir_teknikmesin" placeholder="Masukkan Tempat Lahir" value="<?= $data['tempat_lahir'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="agama" id="agama_teknikmesin" placeholder="Masukkan Agama" value="<?= $data['agama'] ?>">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="alamat" id="alamat_teknikmesin" placeholder="Masukkan Alamat"><?= $data['alamat'] ?></textarea>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="no_hp" id="no_hp_teknikmesin" placeholder="Masukkan No HP" value="<?= $data['no_hp'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="no_rumah" id="no_rumah_teknikmesin" placeholder="Masukkan No Rumah" value="<?= $data['no_rumah'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="asal_sd" id="asal_sd_teknikmesin" placeholder="Masukkan Asal SD" value="<?= $data['asal_sd'] ?>">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" name="tanggal_sd" id="tanggal_sd_teknikmesin" value="<?= $data['tanggal_sd'] ?>">
          <?php if (form_error('tanggal_sd')) : ?>
            <span class="text-danger"><?= form_error('tanggal_sd') ?></span>
          <?php endif; ?>
        </div>
        <div class="form-group">
          <label for="noijasah_sd_teknikmesin">No Ijasah SD</label>
          <input type="text" class="form-control" name="noijasah_sd" id="noijasah_sd_teknikmesin" placeholder="Masukkan No Ijasah SD" value="<?= $data['noijasah_sd'] ?>">
        ...
        <div class="form-group">
              ...
              <input type="text" class="form-control" name="asal_sltp" id="asal_sltp_teknikmesin" placeholder="Masukkan Asal SLTP" value="<?= $data['asal_sltp'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tanggal_sltp" id="tanggal_sltp_teknikmesin" value="<?= $data['tanggal_sltp'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noijasah_sltp" id="no_ijasah_sltp_teknikmesin" placeholder="Masukkan No Ijasah SLTP" value="<?= $data['noijasah_sltp'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="asal_slta" id="asal_slta_teknikmesin" placeholder="Masukkan Asal SLTA" value="<?= $data['asal_slta'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tanggal_slta" id="tanggal_slta_teknikmesin" value="<?= $data['tanggal_slta'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noijasah_slta" id="no_ijasah_slta_teknikmesin" placeholder="Masukkan No Ijasah SLTA" value="<?= $data['noijasah_slta'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="kualifikasi_d3" id="kualifikasi_d3_teknikmesin" placeholder="Masukkan Kualifikasi D3" value="<?= $data['kualifikasi_d3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="universitas_d3" id="universitas_d3_teknikmesin" placeholder="Masukkan Universitas D3" value="<?= $data['universitas_d3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tanggal_d3" id="tanggal_d3_teknikmesin" value="<?= $data['tanggal_d3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noijasah_d3" id="no_ijasah_d3_teknikmesin" placeholder="Masukkan No Ijasah D3" value="<?= $data['noijasah_d3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="gelar_d3" id="gelar_d3_teknikmesin" placeholder="Masukkan Gelar D3" value="<?= $data['gelar_d3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="kualifikasi_s1" id="kualifikasi_s1_teknikmesin" placeholder="Masukkan Kualifikasi S1" value="<?= $data['kualifikasi_s1'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="universitas_s1" id="universitas_s1_teknikmesin" placeholder="Masukkan Universitas S1" value="<?= $data['universitas_s1'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tanggal_s1" id="tanggal_s1_teknikmesin" value="<?= $data['tanggal_s1'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noijasah_s1" id="no_ijasah_s1_teknikmesin" placeholder="Masukkan No Ijasah S1" value="<?= $data['noijasah_s1'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="gelar_s1" id="gelar_s1_teknikmesin" placeholder="Masukkan Gelar S1" value="<?= $data['gelar_s1'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="kualifikasi_s2" id="kualifikasi_s2_teknikmesin" placeholder="Masukkan Kualifikasi S2" value="<?= $data['kualifikasi_s2'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="universitas_s2" id="universitas_s2_teknikmesin" placeholder="Masukkan Universitas S2" value="<?= $data['universitas_s2'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tanggal_s2" id="tanggal_s2_teknikmesin" value="<?= $data['tanggal_s2'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noijasah_s2" id="no_ijasah_s2_teknikmesin" placeholder="Masukkan No Ijasah S2" value="<?= $data['noijasah_s2'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="gelar_s2" id="gelar_s2_teknikmesin" placeholder="Masukkan Gelar S2" value="<?= $data['gelar_s2'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="kualifikasi_s3" id="kualifikasi_s3_teknikmesin" placeholder="Masukkan Kualifikasi S3" value="<?= $data['kualifikasi_s3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="universitas_s3" id="universitas_s3_teknikmesin" placeholder="Masukkan Universitas S3" value="<?= $data['universitas_s3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tanggal_s3" id="tanggal_s3_teknikmesin" value="<?= $data['tanggal_s3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noijasah_s3" id="no_ijasah_s3_teknikmesin" placeholder="Masukkan No Ijasah S3" value="<?= $data['noijasah_s3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="gelar_s3" id="gelar_s3_teknikmesin" placeholder="Masukkan Gelar S3" value="<?= $data['gelar_s3'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sertifikat_formal" id="sertifikat_formal_teknikmesin" placeholder="Masukkan Sertifikat Formal" value="<?= $data['sertifikat_formal'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sertifikat_nonformal" id="sertifikat_nonformal_teknikmesin" placeholder="Masukkan Sertifikat Nonformal" value="<?= $data['sertifikat_nonformal'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sk_cpns" id="sk_cpns_teknikmesin" placeholder="Masukkan SK CPNS" value="<?= $data['sk_cpns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tmt_cpns" id="tmt_cpns_teknikmesin" value="<?= $data['tmt_cpns'] ?>">
              <?php if (form_error('tmt_cpns')) : ?>
                <span class="text-danger"><?= form_error('tmt_cpns') ?></span>
              <?php endif; ?>
            </div>
            <div class="form-group">
              <label for="pejabat_cpns_teknikmesin">Pejabat Yang Mengangkat CPNS</label>
              <input type="text" class="form-control" name="pejabat_cpns" id="pejabat_cpns_teknikmesin" placeholder="Masukkan Pejabat CPNS" value="<?= $data['pejabat_cpns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="spmt_cpns" id="spmt_cpns_teknikmesin" placeholder="Masukkan SPMT CPNS" value="<?= $data['spmt_cpns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tglspmt_cpns" id="tglspmt_cpns_teknikmesin" value="<?= $data['tglspmt_cpns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sttpl_cpns" id="sttpl_cpns_teknikmesin" placeholder="Masukkan STTPL CPNS" value="<?= $data['sttpl_cpns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tglsttpl_cpns" id="tglsttpl_cpns_teknikmesin" value="<?= $data['tglsttpl_cpns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sk_pns" id="sk_pns_teknikmesin" placeholder="Masukkan SK PNS" value="<?= $data['sk_pns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tmt_pns" id="tmt_pns_teknikmesin" value="<?= $data['tmt_pns'] ?>">
              <?php if (form_error('tmt_pns')) : ?>
                <span class="text-danger"><?= form_error('tmt_pns') ?></span>
              <?php endif; ?>
            </div>
            <div class="form-group">
              <label for="pejabat_pns_teknikmesin">Pejabat Yang Mengangkat PNS</label>
              <input type="text" class="form-control" name="pejabat_pns" id="pejabat_pns_teknikmesin" placeholder="Masukkan Pejabat PNS" value="<?= $data['pejabat_pns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="karis_pns" id="karis_pns_teknikmesin" placeholder="Masukkan KARIS PNS" value="<?= $data['karis_pns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="taspen_pns" id="taspen_pns_teknikmesin" placeholder="Masukkan TASPEN PNS" value="<?= $data['taspen_pns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="karpeg_pns" id="karpeg_pns_teknikmesin" placeholder="Masukkan KARPEG PNS" value="<?= $data['karpeg_pns'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sk_dostap" id="sk_dostap_teknikmesin" placeholder="Masukkan SK DOSTAP" value="<?= $data['sk_dostap'] ?>">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="tmt_dostap" id="tmt_dostap_teknikmesin" value="<?= $data['tmt_dostap'] ?>">
              <?php if (form_error('tmt_dostap')) : ?>
                <span class="text-danger"><?= form_error('tmt_dostap') ?></span>
              <?php endif; ?>
            </div>
            <div class="form-group">
                            <label for="pejabat_dostap_teknikmesin">Pejabat Yang Mengangkat DOSTAP</label>
                            <input type="text" class="form-control" name="pejabat_dostap" id="pejabat_dostap_teknikmesin" placeholder="Masukkan SK Jabatan" value="<?= isset($data['pejabat_dostap']) ? $data['pejabat_dostap'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sk_dostrak" id="sk_dostrak_teknikmesin" placeholder="Masukkan SK DOSTRAK" value="<?= isset($data['sk_dostrak']) ? $data['sk_dostrak'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt_dostrak" id="tmt_dostrak_teknikmesin" value="<?= isset($data['tmt_dostrak']) ? $data['tmt_dostrak'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pejabat_dostrak" id="pejabat_dostrak_teknikmesin" placeholder="Masukkan Pejabat DOSTRAK" value="<?= isset($data['pejabat_dostrak']) ? $data['pejabat_dostrak'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sk_petap" id="sk_petap_teknikmesin" placeholder="Masukkan SK PETAP" value="<?= isset($data['sk_petap']) ? $data['sk_petap'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt_petap" id="tmt_petap_teknikmesin" value="<?= isset($data['tmt_petap']) ? $data['tmt_petap'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pejabat_petap" id="pejabat_petap_teknikmesin" placeholder="Masukkan Pejabat PETAP" value="<?= isset($data['pejabat_petap']) ? $data['pejabat_petap'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sk_petrak" id="sk_petrak_teknikmesin" placeholder="Masukkan SK PETRAK" value="<?= isset($data['sk_petrak']) ? $data['sk_petrak'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt_petrak" id="tmt_petrak_teknikmesin" value="<?= isset($data['tmt_petrak']) ? $data['tmt_petrak'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pejabat_petrak" id="pejabat_petrak_teknikmesin" placeholder="Masukkan Pejabat PETRAK" value="<?= isset($data['pejabat_petrak']) ? $data['pejabat_petrak'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nip" id="nip_teknikmesin" placeholder="Masukkan NIP" value="<?= isset($data['nip']) ? $data['nip'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nidn" id="nidn_teknikmesin" placeholder="Masukkan NIDN" value="<?= isset($data['nidn']) ? $data['nidn'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nik" id="nik_teknikmesin" placeholder="Masukkan NIK" value="<?= isset($data['nik']) ? $data['nik'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_ak1" id="total_ak1_teknikmesin" placeholder="Masukkan Total AK Asisten Ahli/III.a (100)" value="<?= isset($data['total_ak1']) ? $data['total_ak1'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt1" id="tmt1_teknikmesin" value="<?= isset($data['tmt1']) ? $data['tmt1'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_sk1" id="no_sk1_teknikmesin" placeholder="Masukkan No SK PAK Asisten Ahli/III.a (100)" value="<?= isset($data['no_sk1']) ? $data['no_sk1'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_ak2" id="total_ak2_teknikmesin" placeholder="Masukkan Total AK Asisten Ahli/III.b (150)" value="<?= isset($data['total_ak2']) ? $data['total_ak2'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt2" id="tmt2_teknikmesin" value="<?= isset($data['tmt2']) ? $data['tmt2'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_sk2" id="no_sk2_teknikmesin" placeholder="Masukkan No SK PAK Asisten Ahli/III.b (150)" value="<?= isset($data['no_sk2']) ? $data['no_sk2'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_ak3" id="total_ak3_teknikmesin" placeholder="Masukkan Total AK Lektor/III.c (200)" value="<?= isset($data['total_ak3']) ? $data['total_ak3'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt3" id="tmt3_teknikmesin" value="<?= isset($data['tmt3']) ? $data['tmt3'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_sk3" id="no_sk3_teknikmesin" placeholder="Masukkan No SK PAK Lektor/III.c (200)" value="<?= isset($data['no_sk3']) ? $data['no_sk3'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_ak4" id="total_ak4_teknikmesin" placeholder="Masukkan Total AK Lektor/III.d (300)" value="<?= isset($data['total_ak4']) ? $data['total_ak4'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt4" id="tmt4_teknikmesin" value="<?= isset($data['tmt4']) ? $data['tmt4'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_sk4" id="no_sk4_teknikmesin" placeholder="Masukkan No SK PAK Lektor/III.d (300)" value="<?= isset($data['no_sk4']) ? $data['no_sk4'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="total_ak5" id="total_ak5_teknikmesin" placeholder="Masukkan Total AK Lekor Kepala/IV.a (400)" value="<?= isset($data['total_ak5']) ? $data['total_ak5'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tmt5" id="tmt5_teknikmesin" value="<?= isset($data['tmt5']) ? $data['tmt5'] : '' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_sk5" id="no_sk5_teknikmesin" placeholder="Masukkan No SK PAK Lekor Kepala/IV.a (400)" value="<?= isset($data['no_sk5']) ? $data['no_sk5'] : '' ?>">
    ...
    <input type="text" class="form-control" name="total_ak6" id="total_ak6_teknikmesin" value="<?= set_value('total_ak6', $data['total_ak6']) ?>" placeholder="Masukkan Total AK Lekor Kepala/IV.b (550)">
...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="tmt6" id="tmt6_teknikmesin" value="<?= set_value('tmt6', $data['tmt6']) ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="no_sk6" id="no_sk6_teknikmesin" value="<?= set_value('no_sk6', $data['no_sk6']) ?>" placeholder="Masukkan No SK PAK Lekor Kepala/IV.b (550)">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="tmt7" id="tmt7_teknikmesin" value="<?= set_value('tmt7', $data['tmt7']) ?>" placeholder="Masukkan TMT Penata Muda/III.a">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="no_sk7" id="no_sk7_teknikmesin" value="<?= set_value('no_sk7', $data['no_sk7']) ?>" placeholder="Masukkan No SK Penata Muda/III.a">
...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="tgl_sk7" id="tgl_sk7_teknikmesin" value="<?= set_value('tgl_sk7', $data['tgl_sk7']) ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="bkn_sk7" id="bkn_sk7_teknikmesin" value="<?= set_value('bkn_sk7', $data['bkn_sk7']) ?>" placeholder="Masukkan BKN Penata Muda/III.a">
...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="tglbkn_sk7" id="tglbkn_sk7_teknikmesin" value="<?= set_value('tglbkn_sk7', $data['tglbkn_sk7']) ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="jenis_pangkat7" id="jenis_pangkat7_teknikmesin" value="<?= set_value('jenis_pangkat7', $data['jenis_pangkat7']) ?>" placeholder="Masukkan Jenis Pangkat Penata Muda/III.a">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="tmt8" id="tmt8_teknikmesin" value="<?= set_value('tmt8', $data['tmt8']) ?>" placeholder="Masukkan TMT Penata Muda Tk.I/III.b">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="no_sk8" id="no_sk8_teknikmesin" value="<?= set_value('no_sk8', $data['no_sk8']) ?>" placeholder="Masukkan No SK Penata Muda Tk.I/III.b">
...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="tgl_sk8" id="tgl_sk8_teknikmesin" value="<?= set_value('tgl_sk8', $data['tgl_sk8']) ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="bkn_sk8" id="bkn_sk8_teknikmesin" value="<?= set_value('bkn_sk8', $data['bkn_sk8']) ?>" placeholder="Masukkan BKN Penata Muda Tk.I/III.b">
...
<div class="form-group">
    ...
    <input type="date" class="form-control" name="tglbkn_sk8" id="tglbkn_sk8_teknikmesin" value="<?= set_value('tglbkn_sk8', $data['tglbkn_sk8']) ?>">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="jenis_pangkat8" id="jenis_pangkat8_teknikmesin" value="<?= set_value('jenis_pangkat8', $data['jenis_pangkat8']) ?>" placeholder="Masukkan Jenis Pangkat Penata Muda Tk.I/III.b">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="tmt9" id="tmt9_teknikmesin" value="<?= set_value('tmt9', $data['tmt9']) ?>" placeholder="Masukkan TMT Penata/III.c">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="no_sk9" id="no_sk9_teknikmesin" value="<?= set_value('no_sk9', $data['no_sk9']) ?>" placeholder="Masukkan No SK Penata/III.c">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tgl_sk9" id="tgl_sk9_teknikmesin" value="<?= set_value('tgl_sk9', $data['tgl_sk9']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="bkn_sk9" id="bkn_sk9_teknikmesin" value="<?= set_value('bkn_sk9', $data['bkn_sk9']) ?>" placeholder="Masukkan BKN Penata/III.c">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tglbkn_sk9" id="tglbkn_sk9_teknikmesin" value="<?= set_value('tglbkn_sk9', $data['tglbkn_sk9']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="jenis_pangkat9" id="jenis_pangkat9_teknikmesin" value="<?= set_value('jenis_pangkat9', $data['jenis_pangkat9']) ?>" placeholder="Masukkan Jenis Pangkat Penata/III.c">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="tmt10" id="tmt10_teknikmesin" value="<?= set_value('tmt10', $data['tmt10']) ?>" placeholder="Masukkan TMT Penata Tk.I/III.d">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="no_sk10" id="no_sk10_teknikmesin" value="<?= set_value('no_sk10', $data['no_sk10']) ?>" placeholder="Masukkan No SK Penata Tk.I/III.d">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tgl_sk10" id="tgl_sk10_teknikmesin" value="<?= set_value('tgl_sk10', $data['tgl_sk10']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="bkn_sk10" id="bkn_sk10_teknikmesin" value="<?= set_value('bkn_sk10', $data['bkn_sk10']) ?>" placeholder="Masukkan BKN Penata Tk.I/III.d">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tglbkn_sk10" id="tglbkn_sk10_teknikmesin" value="<?= set_value('tglbkn_sk10', $data['tglbkn_sk10']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="jenis_pangkat10" id="jenis_pangkat10_teknikmesin" value="<?= set_value('jenis_pangkat10', $data['jenis_pangkat10']) ?>" placeholder="Masukkan Jenis Pangkat Penata Tk.I/III.d">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="tmt11" id="tmt11_teknikmesin" value="<?= set_value('tmt11', $data['tmt11']) ?>" placeholder="Masukkan TMT Pembina/IV.a">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="no_sk11" id="no_sk11_teknikmesin" value="<?= set_value('no_sk11', $data['no_sk11']) ?>" placeholder="Masukkan No SK Pembina/IV.a">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tgl_sk11" id="tgl_sk11_teknikmesin" value="<?= set_value('tgl_sk11', $data['tgl_sk11']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="bkn_sk11" id="bkn_sk11_teknikmesin" value="<?= set_value('bkn_sk11', $data['bkn_sk11']) ?>" placeholder="Masukkan BKN Pembina/IV.a">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tglbkn_sk11" id="tglbkn_sk11_teknikmesin" value="<?= set_value('tglbkn_sk11', $data['tglbkn_sk11']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="jenis_pangkat11" id="jenis_pangkat11_teknikmesin" value="<?= set_value('jenis_pangkat11', $data['jenis_pangkat11']) ?>" placeholder="Masukkan Jenis Pangkat Pembina/IV.a">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="tmt12" id="tmt12_teknikmesin" value="<?= set_value('tmt12', $data['tmt12']) ?>" placeholder="Masukkan TMT Pembina Tk.I/IV.b">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="no_sk12" id="no_sk12_teknikmesin" value="<?= set_value('no_sk12', $data['no_sk12']) ?>" placeholder="Masukkan No SK Pembina Tk.I/IV.b">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tgl_sk12" id="tgl_sk12_teknikmesin" value="<?= set_value('tgl_sk12', $data['tgl_sk12']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="bkn_sk12" id="bkn_sk12_teknikmesin" value="<?= set_value('bkn_sk12', $data['bkn_sk12']) ?>" placeholder="Masukkan BKN Pembina Tk.I/IV.b">
...
<div class="form-group">
  ...
  <input type="date" class="form-control" name="tglbkn_sk12" id="tglbkn_sk12_teknikmesin" value="<?= set_value('tglbkn_sk12', $data['tglbkn_sk12']) ?>">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="jenis_pangkat12" id="jenis_pangkat12_teknikmesin" value="<?= set_value('jenis_pangkat12', $data['jenis_pangkat12']) ?>" placeholder="Masukkan Jenis Pangkat Pembina Tk.I/IV.b">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nama_ayah" id="nama_ayah_teknikmesin" value="<?= set_value('nama_ayah', $data['nama_ayah']) ?>" placeholder="Masukkan Nama Ayah">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nama_ibu" id="nama_ibu_teknikmesin" value="<?= set_value('nama_ibu', $data['nama_ibu']) ?>" placeholder="Masukkan Nama Ibu">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nama_pasangan" id="nama_pasangan_teknikmesin" value="<?= set_value('nama_pasangan', $data['nama_pasangan']) ?>" placeholder="Masukkan Nama Pasangan">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nama_anak" id="nama_anak_teknikmesin" value="<?= set_value('nama_anak', $data['nama_anak']) ?>" placeholder="Masukkan Nama Anak">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="npwp" id="npwp_teknikmesin" value="<?= set_value('npwp', $data['npwp']) ?>" placeholder="Masukkan NPWP">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nomor_rekening" id="nomor_rekening_teknikmesin" value="<?= set_value('nomor_rekening', $data['nomor_rekening']) ?>" placeholder="Masukkan Nomor Rekening">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nama_kartu" id="nama_kartu_teknikmesin" value="<?= set_value('nama_kartu', $data['nama_kartu']) ?>" placeholder="Masukkan Nama Kartu">
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="nomor_kartu" id="nomor_kartu_teknikmesin" value="<?= set_value('nomor_kartu', $data['nomor_kartu']) ?>" placeholder="Masukkan Nomor Kartu">
...
<script>
  $(document).ready(function() {
    // Initialize form visibility based on the type (teknikmesin/tendik)
    let jenis = "<?= $data['jenis'] ?>"; // assuming the type is stored in $data['jenis']
    if (jenis == 'teknikmesin') {
      $('#teknikmesin-form').show();
      $('#tendik-form').hide();
    } else if (jenis == 'tendik') {
      $('#tendik-form').show();
      $('#teknikmesin-form').hide();
    } else {
      $('#teknikmesin-form').hide();
      $('#tendik-form').hide();
    }
